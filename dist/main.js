...
eval("\n\nmodule.exports = function (i) {\n  return i[1];\n};\n\n//# sourceURL=webpack://todo-list2/./node_modules/css-loader/dist/runtime/noSourceMaps.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction insertStyleElement(options) {\n  var element = document.createElement(\"style\");\n  options.setAttributes(element, options.attributes);\n  options.insert(element, options.options);\n  return element;\n}\n\nmodule.exports = insertStyleElement;\n\n//# sourceURL=webpack://todo-list2/./node_modules/style-loader/dist/runtime/insertStyleElement.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction setAttributesWithoutAttributes(styleElement) {\n  var nonce =  true ? __webpack_require__.nc : 0;\n\n  if (nonce) {\n    styleElement.setAttribute(\"nonce\", nonce);\n  }\n}\n\nmodule.exports = setAttributesWithoutAttributes;\n\n//# sourceURL=webpack://todo-list2/./node_modules/style-loader/dist/runtime/setAttributesWithoutAttributes.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction styleTagTransform(css, styleElement) {\n  if (styleElement.styleSheet) {\n    styleElement.styleSheet.cssText = css;\n  } else {\n    while (styleElement.firstChild) {\n      styleElement.removeChild(styleElement.firstChild);\n    }\n\n    styleElement.appendChild(document.createTextNode(css));\n  }\n}\n\nmodule.exports = styleTagTransform;\n\n//# sourceURL=webpack://todo-list2/./node_modules/style-loader/dist/runtime/styleTagTransform.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"deleteProject\": () => (/* binding */ deleteProject)\n/* harmony export */ });\n/* harmony import */ var _selectProject__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./selectProject */ \"./src/selectProject.js\");\n/* harmony import */ var _toDo__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./toDo */ \"./src/toDo.js\");\n\n\n\nfunction deleteProject(projectName){\n    const projectCloseIcon = document.getElementById(\"icon\"+projectName)\n    projectCloseIcon.addEventListener(\"click\",function(){\n        let projectParentName = projectCloseIcon.parentNode.id\n        _toDo__WEBPACK_IMPORTED_MODULE_1__.toDoList.forEach(element => {\n        if (element.project == projectName){\n            document.getElementById(element.title).remove()\n            const index = _toDo__WEBPACK_IMPORTED_MODULE_1__.toDoList.indexOf(element)\n            _toDo__WEBPACK_IMPORTED_MODULE_1__.toDoList.splice(index,1)\n        }\n    });\n    document.getElementById(projectName).remove()\n    ;(0,_selectProject__WEBPACK_IMPORTED_MODULE_0__.changeHeader)('defaultproject')\n})}\n\n\n\n//# sourceURL=webpack://todo-list2/./src/deleteProject.js?");
